...
export class BytesWriter {
    ...
    public writeU256(value: safeU256): void {
    ...
    public writeTuple(value: safeU256[]): void {
    ...
    public writeAddressValueTupleMap(map: Map<Address, safeU256>): void {
        ...
        for (let i = 0; i < keys.length; i++) {
            ...
            const value: safeU256 = map.get(key) || safeU256.Zero;
